...
bash-скрипт, который выводит на экран информацию в виде:
...
После вывода значений предлошается записать данные в файл (предложить пользователю ответить **Y/N**).  
...
bash-скрипт, за основу которого взят скрипт из [**Part 2**](#part-2-исследование-системы) 
...
bash-скрипт, за основу которого взят скрипт из [**Part 3**](#part-3-визуальное-оформление-вывода-для-скрипта-исследования-системы). Обозначения цветов аналогичные.  
...
bash-скрипт, который запускается с одним параметром.  
